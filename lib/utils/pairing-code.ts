...
export function getBackendApiUrl(): string {
  if (typeof window === 'undefined') {
    return process.env.NEXT_PUBLIC_API_URL || 'https://showmanly-proevolutionary-kasie.ngrok-free.dev';
  }
  ...
  const wsUrl = getWsUrl() || process.env.NEXT_PUBLIC_WS_URL || 'wss://showmanly-proevolutionary-kasie.ngrok-free.dev/ws';
  ...
  const apiUrl = httpUrl || 'https://showmanly-proevolutionary-kasie.ngrok-free.dev';
